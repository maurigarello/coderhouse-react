...
const ItemCount = () => {
  ...
  const Agregar = () =>  count > stock ? alert('no hay stock') : (stock = stock - count ,alert(`se agregaron ${count} al carrito`));
  ...
  return (
    <div className="flex items-center w-28 ml-auto mr-auto pt-8">
      ...
      <button onClick={Agregar} className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white ml-20 py-2 px-4 border border-blue-500 hover:border-transparent rounded">
  Agregar al carrito
</button>
    </div>
  );
